      ...
      (error) => {
        ...
        switch (error.code) {
          case error.PERMISSION_DENIED:
            errorMessage = "User denied the request for Geolocation. Weather from a random location will be displayed instead. Click the Get Location button to change random locations. For better geolocation results, please use a desktop computer.";
            break;
          case error.POSITION_UNAVAILABLE:
            errorMessage = "Location information is unavailable. Weather from a random location will be displayed instead. Click the Get Location button to change random locations. For better geolocation results, please use a desktop computer.";
            break;
          case error.TIMEOUT:
            errorMessage = "The request to get user location timed out. Weather from a random location will be displayed instead. Click the Get Location button to change random locations. For better geolocation results, please use a desktop computer. ";
            break;
          default:
            errorMessage = "An unknown error occurred. Weather from a random location will be displayed instead. Click the Get Location button to change random locations. For better geolocation results, please use a desktop computer. ";
            break;
        }
